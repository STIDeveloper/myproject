 ...
 <h1>Bienvenue sur mon super forum !</h1>
            ...
            <div id="Cforum">
                ...
                while($reponse = $requete->fetch()){
                    ?>
                     <div class="categories">
                         <a href="indexta.php?sujet=<?php echo $reponse['name'] ?>"><h1><?php echo $reponse['name'] ?></h1></a>
                    </div>
                    <?php
                }
                ?>
                ...
                ?>
                 ...
                 <form method="post" action="indexta.php?sujet=<?php echo $_GET['sujet']; ?>">
                ...
                <?php
                        ...
                        ?>
                            <div class="categories">
                                <a href="indexta.php?categorie=<?php echo $reponse['name']; ?>"><?php echo $reponse['name']; ?></a>
                              </div>
